...
function createArticle(
  ...
  panel.appendChild(artTitle);
  panel.appendChild(artDate);
  panel.appendChild(artFirstParagraph);
  panel.appendChild(artSecondParagraph);
  panel.appendChild(artThirdParagraph);
